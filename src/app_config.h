...
typedef struct {
  ...
  double lyrics_top_outline_width;
  double lyrics_top_shadow_x;
  double lyrics_top_shadow_y;
  double lyrics_top_shadow_opacity;
  double lyrics_bottom_outline_width;
  double lyrics_bottom_shadow_x;
  double lyrics_bottom_shadow_y;
  double lyrics_bottom_shadow_opacity;
  ...
  GdkRGBA lyrics_top_outline_color;
  GdkRGBA lyrics_top_shadow_color;
  GdkRGBA lyrics_bottom_text_color;
  GdkRGBA lyrics_bottom_outline_color;
  GdkRGBA lyrics_bottom_shadow_color;
